...
public class FlatMapTest {
    ...
    public void whenDiffNext() {
        ...
        MatcherAssert.assertThat(flat.next(), is(1));
        MatcherAssert.assertThat(flat.next(), is(2));
        MatcherAssert.assertThat(flat.next(), is(3));
    }
    ...
    public void whenMultiHasNext() {
        ...
        FlatMap<Integer> flat = new FlatMap<>(data);
        MatcherAssert.assertThat(flat.hasNext(), is(true));
        MatcherAssert.assertThat(flat.hasNext(), is(true));
    }
    ...
    public void whenHasNextFalse() {
        ...
        FlatMap<Integer> flat = new FlatMap<>(data);
        MatcherAssert.assertThat(flat.next(), is(1));
        MatcherAssert.assertThat(flat.hasNext(), is(false));
    }
    ...
    public void whenSeveralEmptyAndNotEmpty() {
        ...
        MatcherAssert.assertThat(1, is(flat.next()));
    }
